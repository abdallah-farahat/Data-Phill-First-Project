...
If Object_Id('Staging.Crm_closed_deals','U') Is Not Null
	Drop Table Staging.Crm_closed_deals;

Create Table Staging.Crm_closed_deals(
	mql_id Nvarchar(50),
...
If Object_Id('Staging.Crm_customers_dataset','U') Is Not Null
	Drop Table Staging.Crm_customers_dataset;

Create Table Staging.Crm_customers_dataset(
...
If Object_Id('Staging.Crm_marketing_qualified_leads','U') Is Not Null
	Drop Table Staging.Crm_marketing_qualified_leads;

Create Table Staging.Crm_marketing_qualified_leads(
	mql_id Nvarchar(50),
...
If Object_Id('Staging.Crm_order_reviews','U') Is Not Null
	Drop Table Staging.Crm_order_reviews;

Create Table Staging.Crm_order_reviews(
...
If Object_Id('Staging.Erp_order_payments','U') Is Not Null
	Drop Table Staging.Erp_order_payments;

Create Table Staging.Erp_order_payments(
	order_id Nvarchar(50),
...
If Object_Id('Staging.Erp_sellers','U') Is Not Null
	Drop Table Staging.Erp_sellers;

Create Table Staging.Erp_sellers(
	seller_id Nvarchar(50),
...
If Object_Id('Staging.Erp_product_category_name_translation','U') Is Not Null
	Drop Table Staging.Erp_product_category_name_translation;

Create Table Staging.Erp_product_category_name_translation(
	product_category_name Nvarchar(max),
	product_category_name_english Nvarchar(max)
);
Go

If Object_Id('Staging.Erp_geolocation','U') Is Not Null
	Drop Table Staging.Erp_geolocation;

Create Table Staging.Erp_geolocation(
